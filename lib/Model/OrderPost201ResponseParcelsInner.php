...
/**
 * OrderPost201ResponseParcelsInner Class Doc Comment
 *
 * @category Class
 * @description A parcel with the evermile ID
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class OrderPost201ResponseParcelsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_order_post_201_response_parcels_inner';
    ...
    */
     ...
     * Sets id
     *
     * @param string $id The id of the parcel object in evermile db
     *
     * @return self
     */
    ...
    public function setItemsList($items_list)
    {
        ...
        if ((count($items_list) < 1)) {
            throw new \InvalidArgumentException('invalid length for $items_list when calling OrderPost201ResponseParcelsInner., number of items must be greater than or equal to 1.');
        }
