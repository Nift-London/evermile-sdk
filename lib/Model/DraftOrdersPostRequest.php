...
/**
 * DraftOrdersPostRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class DraftOrdersPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_draft_orders_post_request';
    ...
    public const DRAFT_TYPE_OWN_FLEET = 'ownFleet';
    public const DRAFT_TYPE_REGULAR = 'regular';
     ...
     * @return string[]
     */
    public function getDraftTypeAllowableValues()
    {
        return [
            self::DRAFT_TYPE_OWN_FLEET,
            self::DRAFT_TYPE_REGULAR,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('draft_type', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getDraftTypeAllowableValues();
        if (!is_null($this->container['draft_type']) && !in_array($this->container['draft_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'draft_type', must be one of '%s'",
                $this->container['draft_type'],
     ...
     * Sets draft_order_id
     *
     * @param string|null $draft_order_id The draft's evermile ID. Used for updating a draft order (if provided)
     *
     * @return self
     */
     ...
     * Sets merchant_id
     *
     * @param string|null $merchant_id The merchant's ID
     *
     * @return self
     */
    ...
    public function setPickupLocationsIds($pickup_locations_ids)
    {
        ...
        if ((count($pickup_locations_ids) < 1)) {
            throw new \InvalidArgumentException('invalid length for $pickup_locations_ids when calling DraftOrdersPostRequest., number of items must be greater than or equal to 1.');
        }
    ...
    public function setDestinationLocations($destination_locations)
    {
        ...
        if ((count($destination_locations) > 2)) {
            throw new \InvalidArgumentException('invalid value for $destination_locations when calling DraftOrdersPostRequest., number of items must be less than or equal to 2.');
        }
        if ((count($destination_locations) < 1)) {
            throw new \InvalidArgumentException('invalid length for $destination_locations when calling DraftOrdersPostRequest., number of items must be greater than or equal to 1.');
        }
    ...
    public function setParcels($parcels)
    {
        ...
        if ((count($parcels) < 1)) {
            throw new \InvalidArgumentException('invalid length for $parcels when calling DraftOrdersPostRequest., number of items must be greater than or equal to 1.');
        }
    ...
    {
        return $this->container['draft_type'];
    }

    /**
     * Sets draft_type
     *
     * @param string|null $draft_type draft_type
     *
     * @return self
     */
    public function setDraftType($draft_type)
    {
        if (is_null($draft_type)) {
            throw new \InvalidArgumentException('non-nullable draft_type cannot be null');
        }
        $allowedValues = $this->getDraftTypeAllowableValues();
        if (!in_array($draft_type, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'draft_type', must be one of '%s'",
                    $draft_type,
        ...
        $this->container['draft_type'] = $draft_type;
