...
/**
 * LocationPutRequestLocation Class Doc Comment
 *
 * @category Class
 ...
 */
class LocationPutRequestLocation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_location_put_request_location';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id The location's evermile ID. Used for updating a location (if provided)
     *
     * @return self
     */
