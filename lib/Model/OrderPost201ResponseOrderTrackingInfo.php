...
/**
 * OrderPost201ResponseOrderTrackingInfo Class Doc Comment
 *
 * @category Class
 ...
 */
class OrderPost201ResponseOrderTrackingInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_order_post_201_response_orderTrackingInfo';
    ...
    protected static $openAPITypes = [
        ...
        'collection_barcodes_info' => '\OpenAPI\Client\Model\OrderPost201ResponseOrderTrackingInfoAllOfCollectionBarcodesInfo',
        'dropoff_barcodes_info' => '\OpenAPI\Client\Model\OrderPost201ResponseOrderTrackingInfoAllOfCollectionBarcodesInfo',
    ...
    protected static $openAPIFormats = [
        ...
        'collection_barcodes_info' => null,
        'dropoff_barcodes_info' => null,
    ...
    protected static array $openAPINullables = [
        ...
        'collection_barcodes_info' => false,
        'dropoff_barcodes_info' => false,
    ...
    protected static $attributeMap = [
        ...
        'collection_barcodes_info' => 'collectionBarcodesInfo',
        'dropoff_barcodes_info' => 'dropoffBarcodesInfo',
    ...
    protected static $setters = [
        ...
        'collection_barcodes_info' => 'setCollectionBarcodesInfo',
        'dropoff_barcodes_info' => 'setDropoffBarcodesInfo',
    ...
    protected static $getters = [
        ...
        'collection_barcodes_info' => 'getCollectionBarcodesInfo',
        'dropoff_barcodes_info' => 'getDropoffBarcodesInfo',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('collection_barcodes_info', $data ?? [], null);
        $this->setIfExists('dropoff_barcodes_info', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets collection_barcodes_info
     *
     * @return \OpenAPI\Client\Model\OrderPost201ResponseOrderTrackingInfoAllOfCollectionBarcodesInfo|null
     */
    public function getCollectionBarcodesInfo()
    {
        return $this->container['collection_barcodes_info'];
    }

    /**
     * Sets collection_barcodes_info
     *
     * @param \OpenAPI\Client\Model\OrderPost201ResponseOrderTrackingInfoAllOfCollectionBarcodesInfo|null $collection_barcodes_info collection_barcodes_info
     *
     * @return self
     */
    public function setCollectionBarcodesInfo($collection_barcodes_info)
    {
        if (is_null($collection_barcodes_info)) {
            throw new \InvalidArgumentException('non-nullable collection_barcodes_info cannot be null');
        }
        $this->container['collection_barcodes_info'] = $collection_barcodes_info;

        return $this;
    }

    /**
     * Gets dropoff_barcodes_info
     *
     * @return \OpenAPI\Client\Model\OrderPost201ResponseOrderTrackingInfoAllOfCollectionBarcodesInfo|null
     */
    public function getDropoffBarcodesInfo()
    {
        return $this->container['dropoff_barcodes_info'];
    }

    /**
     * Sets dropoff_barcodes_info
     *
     * @param \OpenAPI\Client\Model\OrderPost201ResponseOrderTrackingInfoAllOfCollectionBarcodesInfo|null $dropoff_barcodes_info dropoff_barcodes_info
     *
     * @return self
     */
    public function setDropoffBarcodesInfo($dropoff_barcodes_info)
    {
        if (is_null($dropoff_barcodes_info)) {
            throw new \InvalidArgumentException('non-nullable dropoff_barcodes_info cannot be null');
        }
        $this->container['dropoff_barcodes_info'] = $dropoff_barcodes_info;
