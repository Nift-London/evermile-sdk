...
/**
 * DraftOrdersGet200ResponseDraftsInnerParcelsInnerDimensions Class Doc Comment
 *
 * @category Class
 * @description A parcel&#39;s dimension
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class DraftOrdersGet200ResponseDraftsInnerParcelsInnerDimensions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_draft_orders_get_200_response_drafts_inner_parcels_inner_dimensions';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name The name of this set of dimensions
     *
     * @return self
     */
     ...
     * Sets length_cm
     *
     * @param float|null $length_cm Length of the parcel in centimeters
     *
     * @return self
     */
     ...
     * Sets width_cm
     *
     * @param float|null $width_cm Width of the parcel in centimeters
     *
     * @return self
     */
     ...
     * Sets height_cm
     *
     * @param float|null $height_cm Height of the parcel in centimeters
     *
     * @return self
     */
