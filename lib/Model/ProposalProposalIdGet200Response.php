...
/**
 * ProposalProposalIdGet200Response Class Doc Comment
 *
 * @category Class
 ...
 */
class ProposalProposalIdGet200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_proposal__proposalId__get_200_response';
    ...
    */
     ...
     * Gets proposal
     *
     * @return \OpenAPI\Client\Model\QuotePost200ResponseDateProposalsInnerProposalsInnerProposal
     */
     ...
     * Sets proposal
     *
     * @param \OpenAPI\Client\Model\QuotePost200ResponseDateProposalsInnerProposalsInnerProposal $proposal proposal
     *
     * @return self
     */
    ...
    /**
     * Gets created_order_id
     *
     * @return string|null
     */
    public function getCreatedOrderId()
    {
        return $this->container['created_order_id'];
    }

    /**
     * Sets created_order_id
     *
     * @param string|null $created_order_id If an order was already created from this proposal, this field will contain its ID
     *
     * @return self
     */
    public function setCreatedOrderId($created_order_id)
    {
        if (is_null($created_order_id)) {
