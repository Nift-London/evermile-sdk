...
/**
 * QuoteMultiRoutePostRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class QuoteMultiRoutePostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_quote_multiRoute_post_request';
    ...
    protected static $openAPITypes = [
        'origins' => '\OpenAPI\Client\Model\QuoteMultiRoutePostRequestOriginsInner[]',
        'destinations' => '\OpenAPI\Client\Model\QuoteMultiRoutePostRequestOriginsInner[]',
        'parcels' => '\OpenAPI\Client\Model\QuotePostRequestParcelsInner[]',
        'in_stock' => 'bool',
        'date_range' => '\OpenAPI\Client\Model\QuotePostRequestDestinationLocationsInnerDeliverySlot',
        'params' => '\OpenAPI\Client\Model\QuoteMultiRoutePostRequestParams',
    ...
    */
     ...
     * Sets origins
     *
     * @param \OpenAPI\Client\Model\QuoteMultiRoutePostRequestOriginsInner[] $origins A list of locations details from which the items should be picked up.
     *
     * @return self
     */
     ...
     * Sets destinations
     *
     * @param \OpenAPI\Client\Model\QuoteMultiRoutePostRequestOriginsInner[] $destinations A list of locations details to which the items should be delivered.
     *
     * @return self
     */
     ...
     * Sets parcels
     *
     * @param \OpenAPI\Client\Model\QuotePostRequestParcelsInner[] $parcels The list of parcels that should be picked up and dropped off in this delivery.
     *
     * @return self
     */
    public function setParcels($parcels)
    {
        ...
        if ((count($parcels) < 1)) {
            throw new \InvalidArgumentException('invalid length for $parcels when calling QuoteMultiRoutePostRequest., number of items must be greater than or equal to 1.');
        }
     ...
     * Sets date_range
     *
     * @param \OpenAPI\Client\Model\QuotePostRequestDestinationLocationsInnerDeliverySlot $date_range date_range
     *
     * @return self
     */
     ...
     * Gets params
     *
     * @return \OpenAPI\Client\Model\QuoteMultiRoutePostRequestParams|null
     */
     ...
     * Sets params
     *
     * @param \OpenAPI\Client\Model\QuoteMultiRoutePostRequestParams|null $params params
     *
     * @return self
     */
