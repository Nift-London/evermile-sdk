...
/**
 * DraftOrdersGet200ResponseDraftsInnerParcelsInner Class Doc Comment
 *
 * @category Class
 ...
 */
class DraftOrdersGet200ResponseDraftsInnerParcelsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_draft_orders_get_200_response_drafts_inner_parcels_inner';
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'dimensions' => '\OpenAPI\Client\Model\DraftOrdersGet200ResponseDraftsInnerParcelsInnerDimensions',
        'weight_kg' => 'float',
        'parcel_type' => 'string',
        'template_name' => 'string',
        'items_list' => '\OpenAPI\Client\Model\DraftOrdersGet200ResponseDraftsInnerParcelsInnerItemsListInner[]'
    ];
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id The id of the parcel object in evermile db
     *
     * @return self
     */
     ...
     * Gets dimensions
     *
     * @return \OpenAPI\Client\Model\DraftOrdersGet200ResponseDraftsInnerParcelsInnerDimensions|null
     */
     ...
     * Sets dimensions
     *
     * @param \OpenAPI\Client\Model\DraftOrdersGet200ResponseDraftsInnerParcelsInnerDimensions|null $dimensions dimensions
     *
     * @return self
     */
     ...
     * Sets weight_kg
     *
     * @param float|null $weight_kg Weight of the package in Kilograms
     *
     * @return self
     */
     ...
     * Gets items_list
     *
     * @return \OpenAPI\Client\Model\DraftOrdersGet200ResponseDraftsInnerParcelsInnerItemsListInner[]|null
     */
     ...
     * Sets items_list
     *
     * @param \OpenAPI\Client\Model\DraftOrdersGet200ResponseDraftsInnerParcelsInnerItemsListInner[]|null $items_list items_list
     *
     * @return self
     */
    public function setItemsList($items_list)
    {
        ...
        if ((count($items_list) < 1)) {
            throw new \InvalidArgumentException('invalid length for $items_list when calling DraftOrdersGet200ResponseDraftsInnerParcelsInner., number of items must be greater than or equal to 1.');
        }
