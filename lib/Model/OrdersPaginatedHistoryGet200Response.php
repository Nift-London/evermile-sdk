...
/**
 * OrdersPaginatedHistoryGet200Response Class Doc Comment
 *
 * @category Class
 * @description Response for a orders history request with pagination
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class OrdersPaginatedHistoryGet200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_orders_paginatedHistory_get_200_response';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['last_timestamp'] === null) {
            $invalidProperties[] = "'last_timestamp' can't be null";
        }
     ...
     * Sets last_timestamp
     *
     * @param \DateTime $last_timestamp last_timestamp
     *
     * @return self
     */
