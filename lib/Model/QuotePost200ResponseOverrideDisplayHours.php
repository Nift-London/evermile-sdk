...
/**
 * QuotePost200ResponseOverrideDisplayHours Class Doc Comment
 *
 * @category Class
 ...
 */
class QuotePost200ResponseOverrideDisplayHours implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_quote_post_200_response_overrideDisplayHours';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('afternoon', $data ?? [], null);
    ...
    */
     ...
     * Sets morning
     *
     * @param string|null $morning The morning slot display hours
     *
     * @return self
     */
    ...
    {
        return $this->container['afternoon'];
    }

    /**
     * Sets afternoon
     *
     * @param string|null $afternoon The afternoon slot display hours
     *
     * @return self
     */
    public function setAfternoon($afternoon)
    {
        if (is_null($afternoon)) {
            throw new \InvalidArgumentException('non-nullable afternoon cannot be null');
        }
        $this->container['afternoon'] = $afternoon;
     ...
     * Sets evening
     *
     * @param string|null $evening The evening slot display hours
     *
     * @return self
     */
     ...
     * Sets all_day
     *
     * @param string|null $all_day The all-day slot display hours
     *
     * @return self
     */
