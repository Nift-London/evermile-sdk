...
/**
 * QuotePostRequestParcelsInnerItemsListInner Class Doc Comment
 *
 * @category Class
 ...
 */
class QuotePostRequestParcelsInnerItemsListInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_quote_post_request_parcels_inner_itemsList_inner';
    ...
    */
     ...
     * Sets description
     *
     * @param string $description What the item is
     *
     * @return self
     */
     ...
     * Sets quantity
     *
     * @param int $quantity The number of these items in a parcel
     *
     * @return self
     */
     ...
     * Sets sku
     *
     * @param string|null $sku An optional SKU for this item
     *
     * @return self
     */
     ...
     * Sets weight_kg
     *
     * @param float|null $weight_kg Weight of the item in Kilograms
     *
     * @return self
     */
    ...
    /**
     * Gets collection_config
     *
     * @return \OpenAPI\Client\Model\QuotePostRequestParcelsInnerItemsListInnerCollectionConfig|null
     */
    public function getCollectionConfig()
    {
        return $this->container['collection_config'];
    }

    /**
     * Sets collection_config
     *
     * @param \OpenAPI\Client\Model\QuotePostRequestParcelsInnerItemsListInnerCollectionConfig|null $collection_config collection_config
     *
     * @return self
     */
    public function setCollectionConfig($collection_config)
    {
        if (is_null($collection_config)) {
