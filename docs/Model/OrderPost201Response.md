...
**pickup_location_id** | **string** | The ID of the pickup location | [optional]
...
**pu_notes** | **string[]** | Pickup notes from each delivery in this order | [optional]
...
**created_at** | **\DateTime** | The creation time of the order in ISO8601 format | [optional]
**updated_at** | **\DateTime** | The last update time of the order in ISO8601 format | [optional]
**properties** | [**\OpenAPI\Client\Model\OrderPost201ResponseProperties**](OrderPost201ResponseProperties.md) |  | [optional]
**ecom_order_id** | **string** | The ecom ID of the order | [optional]
**overnight_type** | **string** | The type of overnight delivery (if it&#39;s overnight) | [optional]
**origin_draft_id** | **string** | The original draft order id | [optional]
